...
## weights damage by class; `cancels` is an optional list of explicit routes. Passing an empty
## array produces standalone normals with no authored combo chains.
const BUTTON_SFX := {
	GameConst.Btn.LP: "lp",
	GameConst.Btn.MP: "mp",
	GameConst.Btn.HP: "hp",
...
static func add_standard_normals(c: CharacterData, dmg_scale: float, cancels: Array, clips: Dictionary) -> void:
	...
	var defs := [
		...
		{"id": "st_mp", "display_name": "Stand MP", "button": GameConst.Btn.MP, "stance": GameConst.Stance.STAND,
			...
			"hitstun": 18, "blockstun": 11, "hitstop": 10, "guard": GameConst.Guard.MID, "knockback": 3.8,
			"advance": 1.0,
			"cancel_into": cancels},
		{"id": "st_hp", "display_name": "Stand HP", "button": GameConst.Btn.HP, "stance": GameConst.Stance.STAND,
			...
			"hitstun": 21, "blockstun": 13, "hitstop": 12, "guard": GameConst.Guard.MID, "knockback": 5.0,
			"advance": 1.4,
		...
		{"id": "st_lk", "display_name": "Stand LK", "button": GameConst.Btn.LK, "stance": GameConst.Stance.STAND,
			...
			"hitstun": 14, "blockstun": 9, "hitstop": 9, "guard": GameConst.Guard.MID, "knockback": 3.0,
			"cancel_into": cancels},
		{"id": "st_mk", "display_name": "Stand MK", "button": GameConst.Btn.MK, "stance": GameConst.Stance.STAND,
			...
			"hitstun": 18, "blockstun": 11, "hitstop": 10, "guard": GameConst.Guard.MID, "knockback": 4.2,
			"cancel_into": cancels},
		{"id": "st_hk", "display_name": "Stand HK", "button": GameConst.Btn.HK, "stance": GameConst.Stance.STAND,
			...
			"hitstun": 22, "blockstun": 12, "hitstop": 12, "guard": GameConst.Guard.MID, "knockback": 5.6,
		...
		{"id": "cr_lp", "display_name": "Crouch LP", "button": GameConst.Btn.LP, "stance": GameConst.Stance.CROUCH,
			...
			"hitstun": 13, "blockstun": 9, "hitstop": 9, "guard": GameConst.Guard.MID, "knockback": 3.1,
		...
		{"id": "cr_mp", "display_name": "Crouch MP", "button": GameConst.Btn.MP, "stance": GameConst.Stance.CROUCH,
			...
			"hitstun": 16, "blockstun": 10, "hitstop": 10, "guard": GameConst.Guard.MID, "knockback": 3.5,
			"cancel_into": cancels},
		{"id": "cr_hp", "display_name": "Crouch HP", "button": GameConst.Btn.HP, "stance": GameConst.Stance.CROUCH,
			...
			"hitstun": 22, "blockstun": 12, "hitstop": 12, "guard": GameConst.Guard.MID, "knockback": 3.8,
		...
		{"id": "cr_lk", "display_name": "Crouch LK", "button": GameConst.Btn.LK, "stance": GameConst.Stance.CROUCH,
			...
			"hitstun": 13, "blockstun": 9, "hitstop": 9, "guard": GameConst.Guard.LOW, "knockback": 2.7,
			"cancel_into": cancels},
		{"id": "cr_mk", "display_name": "Crouch MK", "button": GameConst.Btn.MK, "stance": GameConst.Stance.CROUCH,
			...
			"hitstun": 17, "blockstun": 11, "hitstop": 10, "guard": GameConst.Guard.LOW, "knockback": 4.0,
			"cancel_into": cancels},
		{"id": "cr_hk", "display_name": "Sweep", "button": GameConst.Btn.HK, "stance": GameConst.Stance.CROUCH,
			...
			"hitstun": 20, "blockstun": 12, "hitstop": 12, "guard": GameConst.Guard.LOW, "knockback": 4.8,
			"launch": true, "launch_velocity": 5.5},
		# Air (jump-ins; overheads). Compact boxes stay attached to the limb instead of
		# covering the whole jump arc.
		{"id": "air_lp", "display_name": "Air LP", "button": GameConst.Btn.LP, "stance": GameConst.Stance.AIR,
			"startup": 3, "active": 10, "recovery": 4, "damage": 28,
			"hitstun": 16, "blockstun": 10, "hitstop": 9, "guard": GameConst.Guard.OVERHEAD, "knockback": 2.8,
			"hit_offset": Vector3(0.45, 0.35, 0.0), "hit_size": Vector3(0.55, 0.45, 0.65)},
		{"id": "air_mp", "display_name": "Air MP", "button": GameConst.Btn.MP, "stance": GameConst.Stance.AIR,
			"startup": 5, "active": 8, "recovery": 5, "damage": 50,
			"hitstun": 18, "blockstun": 11, "hitstop": 10, "guard": GameConst.Guard.OVERHEAD, "knockback": 3.8,
			"hit_offset": Vector3(0.52, 0.38, 0.0), "hit_size": Vector3(0.65, 0.50, 0.65)},
		{"id": "air_hp", "display_name": "Air HP", "button": GameConst.Btn.HP, "stance": GameConst.Stance.AIR,
			"startup": 7, "active": 8, "recovery": 6, "damage": 80,
			"hitstun": 20, "blockstun": 12, "hitstop": 12, "guard": GameConst.Guard.OVERHEAD, "knockback": 5.0,
			"hit_offset": Vector3(0.58, 0.42, 0.0), "hit_size": Vector3(0.75, 0.55, 0.7)},
		{"id": "air_lk", "display_name": "Air LK", "button": GameConst.Btn.LK, "stance": GameConst.Stance.AIR,
			"startup": 4, "active": 10, "recovery": 4, "damage": 30,
			"hitstun": 16, "blockstun": 10, "hitstop": 9, "guard": GameConst.Guard.OVERHEAD, "knockback": 2.9,
			"hit_offset": Vector3(0.48, 0.18, 0.0), "hit_size": Vector3(0.65, 0.55, 0.65)},
		{"id": "air_mk", "display_name": "Air MK", "button": GameConst.Btn.MK, "stance": GameConst.Stance.AIR,
			"startup": 7, "active": 6, "recovery": 5, "damage": 54,
			"hitstun": 18, "blockstun": 11, "hitstop": 10, "guard": GameConst.Guard.OVERHEAD, "knockback": 4.1,
			"hit_offset": Vector3(0.25, 0.18, 0.0), "hit_size": Vector3(0.95, 0.55, 0.7)},
		{"id": "air_hk", "display_name": "Air HK", "button": GameConst.Btn.HK, "stance": GameConst.Stance.AIR,
			"startup": 8, "active": 8, "recovery": 6, "damage": 86,
			"hitstun": 20, "blockstun": 12, "hitstop": 12, "guard": GameConst.Guard.OVERHEAD, "knockback": 5.3,
			"hit_offset": Vector3(0.55, 0.18, 0.0), "hit_size": Vector3(0.85, 0.65, 0.7)},
	]
	for d in defs:

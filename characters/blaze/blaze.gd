...
const NORMAL_TUNING := {
	...
	"st_mp": {"startup": 6, "active": 3, "recovery": 12, "damage": 48, "hitstun": 18, "blockstun": 11, "hitstop": 8, "guard": GameConst.Guard.MID, "knockback": 3.8, "advance": 1.0, "hit_offset": Vector3(0.80, 1.0, 0.0), "hit_size": Vector3(0.59, 0.42, 0.62), "cancel_into": ["st_hp", "fireball", "uppercut", "hurricane", "super_inferno"]},
	"st_hp": {"startup": 9, "active": 4, "recovery": 18, "damage": 78, "hitstun": 21, "blockstun": 13, "hitstop": 10, "guard": GameConst.Guard.MID, "knockback": 5.0, "advance": 1.4, "hit_offset": Vector3(0.87, 1.02, 0.0), "hit_size": Vector3(0.70, 0.50, 0.68), "cancel_into": ["fireball", "uppercut", "hurricane", "super_inferno"]},

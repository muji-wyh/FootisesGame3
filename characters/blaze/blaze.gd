...
const NORMAL_TUNING := {
	...
	"st_mp": {"startup": 6, "active": 3, "recovery": 12, "damage": 48, "hitstun": 18, "blockstun": 11, "hitstop": 8, "guard": GameConst.Guard.MID, "knockback": 3.8, "advance": 1.0, "hit_offset": Vector3(0.86, 1.0, 0.0), "hit_size": Vector3(0.64, 0.42, 0.62), "cancel_into": ["st_hp", "fireball", "uppercut", "hurricane", "super_inferno"]},
	"st_hp": {"startup": 9, "active": 4, "recovery": 18, "damage": 78, "hitstun": 21, "blockstun": 13, "hitstop": 10, "guard": GameConst.Guard.MID, "knockback": 5.0, "advance": 1.4, "hit_offset": Vector3(0.85, 1.02, 0.0), "hit_size": Vector3(0.68, 0.50, 0.68), "cancel_into": ["fireball", "uppercut", "hurricane", "super_inferno"]},
	...
	"st_mk": {"startup": 7, "active": 4, "recovery": 14, "damage": 51, "hitstun": 18, "blockstun": 11, "hitstop": 8, "guard": GameConst.Guard.MID, "knockback": 4.2, "hit_offset": Vector3(0.72, 0.86, 0.0), "hit_size": Vector3(0.52, 0.40, 0.68), "cancel_into": ["fireball", "uppercut", "hurricane", "super_inferno"]},
	"st_hk": {"startup": 11, "active": 4, "recovery": 20, "damage": 84, "hitstun": 22, "blockstun": 12, "hitstop": 10, "guard": GameConst.Guard.MID, "knockback": 5.6, "hit_offset": Vector3(0.84, 0.98, 0.0), "hit_size": Vector3(0.66, 0.46, 0.72), "launch": true, "launch_velocity": 7.0},

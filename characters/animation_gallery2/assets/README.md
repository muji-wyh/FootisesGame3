# Animation Gallery2 local assets
...
- `model.fbx` and `tex/9CG.png`: compatible display model from
  `C:\uworks\AssetsSource\Fighter_Animation_Pack`

Gallery2 uses only the UE4 NoRootMotion set because the RootMotion and UE5 folders contain the
same actions for different runtime skeleton variants.

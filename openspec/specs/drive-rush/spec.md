# drive-rush Specification

## Purpose

Raw Drive Rush (RDR) from neutral and Drive Rush Cancel (DRC) off a connected cancellable normal, both triggered by `→→`, that spend Drive, advance, and grant frame advantage for combo extension.
